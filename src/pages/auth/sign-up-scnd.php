...
<body class="bg-stone-50 font-inter">
  <div class="flex justify-center items-center h-screen ">
    <form action="../api/sign-up.php" method="post" class="flex flex-col bg-white px-20 py-12 rounded-md w-[24%]">
      ...
      <input type="submit" value="Sign Up" class="px-6 py-2.5 bg-indigo-500 text-white font-semibold hover:bg-indigo-600 transition rounded-lg">
    </form>
  </div>
</body>
